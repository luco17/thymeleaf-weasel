...
public class UserControllerHtmlUnitTest {
    ...
    void testGetUsersAsAdmin() throws Exception {
        ...
        assertThat(headerRow.getCell(0).asNormalizedText()).isEqualTo("UserName");
    ...
    void testAddUser() throws IOException {
        ...
        Optional<DomElement> createUserLink = elements.stream()
                .filter(domElement -> domElement.asNormalizedText().equals("Add users"))
                .findFirst();
        ...
        createUserFormPage.<HtmlTelInput>getElementByName("phoneNumber").setText("+555 123 456");
        createUserFormPage.<HtmlDateInput>getElementByName("birthday").setText("2004-03-27");
